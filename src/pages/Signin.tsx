...
export function Signin() {
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-r from-amber-950 via-amber-700 to-amber-900
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl 
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/70 text-sm">Welcome back to your journey</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <Button onClick={signin} loading={false} text="Sign In" fullWidth={true} />
          </div>
